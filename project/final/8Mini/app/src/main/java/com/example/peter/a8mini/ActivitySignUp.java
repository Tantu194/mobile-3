...
public class ActivitySignUp extends AppCompatActivity {
    ...
    private void addInfoUser() {
        ...
        friend.setEmail(user.getEmail().toString());
        friend.setNickName(user.getEmail().toString());
        myRef.child(user.getUid()).setValue(friend);
        dataRef.child(user.getUid()).setValue(friend);
