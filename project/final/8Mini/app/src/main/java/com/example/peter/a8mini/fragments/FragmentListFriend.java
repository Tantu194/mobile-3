...
import com.example.peter.a8mini.ChatActivity;
import com.example.peter.a8mini.R;
import com.example.peter.a8mini.adapters.AdapterFriendNotification;
import com.example.peter.a8mini.adapters.AdapterListFriend;
import com.example.peter.a8mini.adapters.AdapterListFriendSearch;
import com.example.peter.a8mini.models.Friend;
import com.example.peter.a8mini.models.NotificationItem;
 ...
 */
public class FragmentListFriend extends FragmentAbtract {
    ...
    DatabaseReference refInfo, drInfoFriend, drListFriends;
    FirebaseUser user;
    ...
    private void getAllUser() {
        drInfoFriend.child(user.getUid()).child("img").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                drInfoFriend.removeEventListener(this);
            }
                ...
                if(!dataSnapshot.getKey().equals(null)){
                    ...
                    drInfoFriend.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            friend.setNickName(dataSnapshot.child("nickName").getValue().toString());
                            if(dataSnapshot.child("img").getValue() != null){
                                friend.setImg(dataSnapshot.child("img").getValue().toString());
                            }
                            arrAllUser.add(friend);
                        }
    ...
    private void actionSearchFriend() {
        for(Friend f : arrAllUser){
            if(!arrMyFriends.contains(f.getUid()) && etSearch.getText().toString().equals(f.getEmail()) && !etSearch.getText().toString().equals(user.getEmail())){
    ...
    private void actionNotification() {
        refInfo.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                addInfoFriendNotifi(dataSnapshot.getKey().toString());
        ...
        drInfoFriend.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue() != null){
                    ...
                    if(dataSnapshot.child("img").getValue() != null){
                        item.setImg(dataSnapshot.child("img").getValue().toString());
                    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.menu_activity_friend, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuAddFriend:
                Animation anim_leftRightIn = AnimationUtils.loadAnimation(getContext(),R.anim.anim_left_to_right_in);
            ...
            case R.id.menuSetting:
                Intent intent = new Intent(getContext(), ActivityDetailUser.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                startActivity(intent);
                break;
            case R.id.menuNotify:
                Animation anim_leftRightOut = AnimationUtils.loadAnimation(getContext(),R.anim.anim_right_to_left_out);
